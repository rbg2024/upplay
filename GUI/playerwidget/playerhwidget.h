...
#ifndef _PLAYERHWIDGET_H_INCLUDED_
#define _PLAYERHWIDGET_H_INCLUDED_
#include <QWidget>
...
class PlayerHWidget : public QWidget, public Ui::PlayerHWidget {
    Q_OBJECT;
public:
    PlayerHWidget(QWidget *parent = 0);
